# ============================================================================
# Script : passe1_v2_balises_etape3.py
# Objectif : Étape 3 — corriger balises d’en-tête et de description pour chaque bloc de langue
# ============================================================================
import re
import shutil
...
def formater_bloc_langue(bloc, base_name, langue, date_now):
    en_tete = [
        "##Identification",
        f"#Script : passe1_v2_balises_etape3.py",
        f"#Run at : {date_now}",
        f"#ID file : {base_name}",
        f"##LANG-{langue}",
        "#ID        XX-X-XX",
