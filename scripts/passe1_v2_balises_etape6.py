...
# ============================================================================
# Script : passe1_v2_balises_etape6.py
# Objectif : Étape 6 — Encapsuler les réponses #A------- dans #-[type:text] #- ... -#
# ============================================================================
import re
import shutil
...
def formater_bloc_langue(bloc, base_name, langue, date_now):
    ...
    en_tete = [
        "##Identification",
        f"#Script : passe1_v2_balises_etape6.py",
        f"#Run at : {date_now}",
        f"#ID file : {base_name}",
        f"##LANG-{langue}",
        f"#ID        {id_code}",
