...
#                print(f"[TRACE-LC] Ligne insérée (table={table_idx+1}, ligne={row_idx+1}, colonne={type_cell}): {ligne.strip()}")
    ...
    # Affichage du dictionnaire pour inspection :
#    print("\n[DEBUG] début Contenu du dictionnaire cles_par_ligne :")
#    for i, entree in enumerate(cles_par_ligne):
#        print(f"Ligne {i}: {entree}")
#    print("\n[DEBUG] fin Contenu du dictionnaire cles_par_ligne :")
