...
def transformer_tableau_et_images(doc_path):
    ...
    for table in doc.tables:
        for row in table.rows:
            ...
            # Ajout de la balise image si l’image est détectée
            if image_in_cell:
                if ligne.startswith("#Q") or ligne.startswith("Q"):
                    ligne += " #IMGQ#"
                elif ligne.startswith("#A") or ligne.startswith("A"):
                    ligne += " #IMGA#"
