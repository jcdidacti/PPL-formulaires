# ==============================================================================
# Script : passe0_docx_tab_to_lin_v1_87.py
...
def transformer_tableau_et_images(doc_path):
    ...
    for ligne in lignes_out:
        if "#Q" in ligne and "|" in ligne:
            ...
            lignes_reformatees.append("#Q########################################################")
            lignes_reformatees.append("")  # saut après Q
            lignes_reformatees.append("[place pour images]")  # zone image Q
            lignes_reformatees.append("")  # saut après image
            lignes_reformatees.append(q_texte)
            lignes_reformatees.append("")  # saut avant A

            if "#A" in a_part and "-" in a_part:
                a_texte_raw = a_part[a_part.find("#A") + 2:].lstrip("-").strip()
                lignes_reformatees.append("#A-----------------------------------------------------------------------------------")
                lignes_reformatees.append("")  # saut après A
                lignes_reformatees.append("[place pour images]")  # zone image A
                lignes_reformatees.append("")  # saut après image
