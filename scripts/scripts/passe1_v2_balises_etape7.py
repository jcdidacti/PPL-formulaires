...
# ============================================================================
# Script : passe1_v2_balises_etape7.py
# Objectif : Étape 7 — détecter et conserver les balises #Q####### et #A-------
#             + encapsuler la réponse dans #-[type:text] #- ... -#
# ============================================================================
import re
import shutil
...
def formater_bloc_langue(bloc, base_name, langue, date_now):
    ...
    en_tete = [
        "##Identification",
        f"#Script : passe1_v2_balises_etape7.py",
        f"#Run at : {date_now}",
        f"#ID file : {base_name}",
        f"##LANG-{langue}",
        f"#ID        {id_code}",
