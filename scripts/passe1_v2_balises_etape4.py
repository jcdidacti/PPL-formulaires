...
# ============================================================================
# Script : passe1_v2_balises_etape4.py
# Objectif : Étape 4 — Corriger #ID automatiquement à partir du nom de fichier
# ============================================================================
import re
import shutil
...
def formater_bloc_langue(bloc, base_name, langue, date_now):
    ...
    en_tete = [
        "##Identification",
        f"#Script : passe1_v2_balises_etape4.py",
        f"#Run at : {date_now}",
        f"#ID file : {base_name}",
        f"##LANG-{langue}",
        f"#ID        {id_code}",
